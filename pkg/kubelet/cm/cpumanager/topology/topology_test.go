		...
		},
		{
			...
			machineInfo: cadvisorapi.MachineInfo{
				...
				Topology: []cadvisorapi.Node{
					...
					{Id: 2,
						Cores: []cadvisorapi.Core{
							{SocketID: 1, Id: 24, Threads: []int{24, 72}, UncoreCaches: []cadvisorapi.Cache{{Id: 0}}},
							{SocketID: 1, Id: 25, Threads: []int{25, 73}, UncoreCaches: []cadvisorapi.Cache{{Id: 0}}},
							{SocketID: 1, Id: 26, Threads: []int{26, 74}, UncoreCaches: []cadvisorapi.Cache{{Id: 0}}},
							{SocketID: 1, Id: 27, Threads: []int{27, 75}, UncoreCaches: []cadvisorapi.Cache{{Id: 0}}},
							{SocketID: 1, Id: 28, Threads: []int{28, 76}, UncoreCaches: []cadvisorapi.Cache{{Id: 1}}},
							{SocketID: 1, Id: 29, Threads: []int{29, 77}, UncoreCaches: []cadvisorapi.Cache{{Id: 1}}},
							{SocketID: 1, Id: 30, Threads: []int{30, 78}, UncoreCaches: []cadvisorapi.Cache{{Id: 1}}},
							{SocketID: 1, Id: 31, Threads: []int{31, 79}, UncoreCaches: []cadvisorapi.Cache{{Id: 1}}},
							{SocketID: 1, Id: 32, Threads: []int{32, 80}, UncoreCaches: []cadvisorapi.Cache{{Id: 2}}},
							{SocketID: 1, Id: 33, Threads: []int{33, 81}, UncoreCaches: []cadvisorapi.Cache{{Id: 2}}},
							{SocketID: 1, Id: 34, Threads: []int{34, 82}, UncoreCaches: []cadvisorapi.Cache{{Id: 2}}},
							{SocketID: 1, Id: 35, Threads: []int{35, 83}, UncoreCaches: []cadvisorapi.Cache{{Id: 2}}},
						},
					},
					{Id: 3,
						Cores: []cadvisorapi.Core{
							{SocketID: 1, Id: 36, Threads: []int{36, 84}, UncoreCaches: []cadvisorapi.Cache{{Id: 3}}},
							{SocketID: 1, Id: 37, Threads: []int{37, 85}, UncoreCaches: []cadvisorapi.Cache{{Id: 3}}},
							{SocketID: 1, Id: 38, Threads: []int{38, 86}, UncoreCaches: []cadvisorapi.Cache{{Id: 3}}},
							{SocketID: 1, Id: 39, Threads: []int{39, 87}, UncoreCaches: []cadvisorapi.Cache{{Id: 3}}},
							{SocketID: 1, Id: 40, Threads: []int{40, 88}, UncoreCaches: []cadvisorapi.Cache{{Id: 4}}},
							{SocketID: 1, Id: 41, Threads: []int{41, 89}, UncoreCaches: []cadvisorapi.Cache{{Id: 4}}},
							{SocketID: 1, Id: 42, Threads: []int{42, 90}, UncoreCaches: []cadvisorapi.Cache{{Id: 4}}},
							{SocketID: 1, Id: 43, Threads: []int{43, 91}, UncoreCaches: []cadvisorapi.Cache{{Id: 4}}},
							{SocketID: 1, Id: 44, Threads: []int{44, 92}, UncoreCaches: []cadvisorapi.Cache{{Id: 5}}},
							{SocketID: 1, Id: 45, Threads: []int{45, 93}, UncoreCaches: []cadvisorapi.Cache{{Id: 5}}},
							{SocketID: 1, Id: 46, Threads: []int{46, 94}, UncoreCaches: []cadvisorapi.Cache{{Id: 5}}},
							{SocketID: 1, Id: 47, Threads: []int{47, 95}, UncoreCaches: []cadvisorapi.Cache{{Id: 5}}},
						},
					},
				},
			},
			want: &CPUTopology{
				...
				CPUDetails: map[int]CPUInfo{
					...
					30: {CoreID: 30, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 1},
					31: {CoreID: 31, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 1},
					32: {CoreID: 32, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 2},
					33: {CoreID: 33, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 2},
					34: {CoreID: 34, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 2},
					35: {CoreID: 35, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 2},
					36: {CoreID: 36, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 3},
					37: {CoreID: 37, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 3},
					38: {CoreID: 38, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 3},
					39: {CoreID: 39, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 3},
					40: {CoreID: 40, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 4},
					41: {CoreID: 41, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 4},
					42: {CoreID: 42, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 4},
					43: {CoreID: 43, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 4},
					44: {CoreID: 44, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 5},
					45: {CoreID: 45, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 5},
					46: {CoreID: 46, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 5},
					47: {CoreID: 47, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 5},
					...
					72: {CoreID: 24, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 0},
					73: {CoreID: 25, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 0},
					74: {CoreID: 26, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 0},
					75: {CoreID: 27, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 0},
					76: {CoreID: 28, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 1},
					77: {CoreID: 29, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 1},
					78: {CoreID: 30, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 1},
					79: {CoreID: 31, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 1},
					80: {CoreID: 32, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 2},
					81: {CoreID: 33, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 2},
					82: {CoreID: 34, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 2},
					83: {CoreID: 35, SocketID: 1, NUMANodeID: 2, UnCoreCacheID: 2},
					84: {CoreID: 36, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 3},
					85: {CoreID: 37, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 3},
					86: {CoreID: 38, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 3},
					87: {CoreID: 39, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 3},
					88: {CoreID: 40, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 4},
					89: {CoreID: 41, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 4},
					90: {CoreID: 42, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 4},
					91: {CoreID: 43, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 4},
					92: {CoreID: 44, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 5},
					93: {CoreID: 45, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 5},
					94: {CoreID: 46, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 5},
					95: {CoreID: 47, SocketID: 1, NUMANodeID: 3, UnCoreCacheID: 5},
				},
			},
			wantErr: false,
		},
